This is an Store application to buy products and add coupons built using VB.NET syntax.

The Module contains all constants, variables and common procedures:
